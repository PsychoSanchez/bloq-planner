...
export const generateWeeks = (year: number, quarter: number): WeekData[] => {
  ...
  const firstWeekNumber = Math.ceil((startDate.getTime() - new Date(year, 0, 1).getTime()) / (7 * 24 * 60 * 60 * 1000)) + 1;
...
const projects: Project[] = [
  { id: "1", name: "SMCBS", type: "regular" },
  { id: "2", name: "TABS", type: "regular" },
  { id: "3", name: "ORDER-RS", type: "regular" },
  { id: "4", name: "ACT-AA", type: "regular" },
  { id: "5", name: "ACT-ING", type: "regular" },
  { id: "6", name: "RSV2", type: "regular" },
  { id: "7", name: "CRV2", type: "regular" },
  { id: "8", name: "RELATED", type: "regular" },
  { id: "9", name: "QUALITY", type: "regular" },
  { id: "10", name: "SMC-INC", type: "regular" },
  { id: "11", name: "MLSORT", type: "regular" },
  { id: "12", name: "EATER HACK", type: "hack" },
  { id: "13", name: "SPILLOVER", type: "spillover" },
  { id: "14", name: "TABS/RSV2", type: "regular" },
