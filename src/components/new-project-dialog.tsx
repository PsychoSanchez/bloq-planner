        ...
        <div className="space-y-3 py-2">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            ...
            <Select defaultValue="nopriority">
              ...
              <SelectContent>
                <SelectItem value="nopriority" className="text-xs">No priority</SelectItem>
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="tech-debt" className="text-xs">Tech Debt</SelectItem>
                <SelectItem value="team-event" className="text-xs">Team Event</SelectItem>
                <SelectItem value="spillover" className="text-xs">Spillover</SelectItem>
                <SelectItem value="blocked" className="text-xs">Blocked</SelectItem>
                <SelectItem value="hack" className="text-xs">Hack</SelectItem>
              </SelectContent>
            </Select>
          </div>
